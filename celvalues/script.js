...
const questions = [
    // R/S (関係性)
    { text: "これまで、恋人がいたことがある。", effect: { r: 5, v: 0, a: 0, h: 0 } },
...
const results = {
    "SNML": { name: "トゥルーセル", description: "全ての希望を失った、運命論の体現者。遺伝や環境によって自らの運命は決定づけられたと確信しており、恋愛、社会、そして自己の生そのものに価値を見出さない。社会との関わりを断ち、静かに時が過ぎるのを待つ状態にある。この診断における最も純粋な絶望の形。" },
    "SNAL": { name: "ブルーピル・ドゥーマー", description: "人や社会の善性を信じたいと願いつつも、現実は非情であるという諦観に支配されている。パートナーがいないことや地位の低さに苦しみながらも、その原因を社会の不寛容さや運の悪さに帰し、人間不信にまでは至らない。「いつか誰かが分かってくれるはず」という淡い希望と、深い絶望の間で引き裂かれている。" },
    "SVML": { name: "奮闘する修羅", description: "社会システムを信じず、他人は敵だと認識しているが、その逆境を自らの力で乗り越えようとする強い意志を持つ。ルックスや能力を磨くことに傾倒し、現状の地位から脱却しようと奮闘する。パートナーがいないのは、まだ自分がそのレベルに達していないからだと考え、努力を続ける。" },
    "SVAL": { name: "隠遁する求道者", description: "パートナーはいないが、人生そのものは肯定的。社会や他者を信じており、自分の魅力や価値がまだ見出されていないだけだと考える。特定の趣味や研究に没頭することで自己を確立しようとする。社会との競争からは距離を置き、自らの内なる世界に安らぎと価値を見出す。" },
    "SNMH": { name: "虚無の支配者", description: "社会的地位や経済的な成功は手に入れたが、その先にあるのが完全な虚無であることを知ってしまったタイプ。人間関係や愛情を信じず、全てを冷笑的に見下している。パートナーがいないのは、他者を必要としないからか、あるいは他者が自分のレベルに値しないからだと考えている。" },
    "SNAH": { name: "孤独なエリート", description: "社会的には成功者だが、深い孤独感と虚無感を抱えている。人を信じ、関係を築きたいと願いながらも、その方法が分からない、あるいは自らの地位が邪魔をして真の関係が築けないと感じている。成功と引き換えに、人間的な温かみを失ってしまったのではないかと恐れている。" },
    "SVMH": { name: "超越者", description: "自らの能力で社会的成功を収め、その地位に満足している。人間社会の欺瞞を見抜いているが、それを超越した視点から利用し、楽しむことさえできる。パートナーがいないのは、自らの基準が高すぎるか、あるいは孤高であることが自らの哲学に合致しているから。" },
    "SVAH": { name: "名誉インセル", description: "社会的地位も自己肯定感も高く、いつでもパートナーを作れる潜在能力があるにも関わらず、自らの意思で独身を選んでいる。仕事や趣味、自己実現を優先し、恋愛を必要としていない。インセルではないが、結果的にパートナーがいない状態であるため、この名が与えられる。" },
    "RNML": { name: "破綻した元インセル", description: "かつてパートナーを得て「インセル」を卒業したものの、関係が破綻したか、あるいは関係の中に救いを見出せなかった。結果、以前よりも深い虚無と人間不信に陥っている。「インセルを抜けても地獄だった」という現実に直面し、全てを呪っている。" },
    "RNAL": { name: "倦怠期のノーミー", description: "パートナーはいるが、人生に意味を見出せず、関係は惰性で続いている。人を信じたい気持ちはあるが、日々の生活や将来への不安から無気力になっている。インセルの苦悩はないが、代わりに「ノーミー（一般人）」としての虚無と倦怠を抱えている。" },
    "RVML": { name: "再起を誓う者", description: "過去の恋愛経験を糧に、現状の低い地位から脱却しようと努力する。社会や他人は信用していないが、自分の力で人生を好転させられると信じている。過去のパートナーを見返す、あるいはより良いパートナーを得ることを目標に、自己改善に励む。" },
    "RVAL": { name: "ささやかな幸福者", description: "社会的地位は高くないが、パートナーとの関係の中に確かな幸福を見出している。人間や社会を信じ、ささやかな日常に感謝しながら生きている。この診断の中では最も穏健で、精神的に安定したタイプの一つ。" },
    "RNMH": { name: "腐敗した権力者", description: "地位もパートナーもいるが、その両方を含め、世界の一切を信じていない。人間関係を権力維持や快楽のためのツールとしか見ておらず、深い虚無感を抱えている。愛や信頼といった価値を嘲笑し、シニカルな態度で世界を支配しようとする。" },
    "RNAH": { name: "仮面夫婦のエリート", description: "社会的な体面を保つためにパートナーとの関係を維持しているが、心は満たされていない。内なる虚無を隠し、成功者としての役割を演じ続けている。人を信じたいという気持ちと、地位が作り出す人間関係の空虚さとの間で葛藤している。" },
    "RVMH": { name: "ギガチャド", description: "圧倒的な成功と自信に満ち溢れている。人間社会の力学を熟知し、それを巧みに利用して自らの目的を達成する。パートナーとの関係も、自らの人生を彩る一つの要素として完全にコントロールしている。その自信と態度は、時に傲慢と見られることもある。" },
    "RVAH": { name: "チャド", description: "この診断における、いわば「祝福された存在」。社会的成功、自己肯定感、人間への信頼、そして良好なパートナーシップの全てを手にしている。悩みや葛藤とは無縁に見え、その存在自体が、他の類型にとっては眩しく、時に嫉妬の対象となる理想像。" }
};
